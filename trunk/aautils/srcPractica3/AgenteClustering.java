...
public class AgenteClustering extends Agente {
	...
	private static List<String[]> instanciasRankingArff = new ArrayList<String[]>();

	static {
		loadCentroidsFroMFile();
		loadCentroidAttributes();
		cargaDeDatosDeInstanciaDelArffOriginales();
	}
	 ...
	 */
	public AgenteClustering(String _codSimulacion, String _nombreMercado, String _nombreEquipo, String _nombreLogEstados, String _nombreLogDecisiones) {
	 ...
	 */
	public AgenteClustering(String _codSimulacion, String _nombreMercado, String _nombreEquipo, String _nombreLogEstados, String _nombreLogDecisiones, String _nombreLogEstadosDecisiones) {
		super(_codSimulacion, _nombreMercado, _nombreEquipo, _nombreLogEstados, _nombreLogDecisiones, _nombreLogEstadosDecisiones);
	}

	private static void loadCentroidAttributes() {
	...
	private static void loadCentroidsFroMFile() {
		try {
	...
	private static void cargaDeDatosDeInstanciaDelArffOriginales() {
		try {
	...
	public Decisiones tomarDecisiones() {
		double[] distancesToClusters = calculateDistancesToClusters(numberOfClusters);
		String cluster = "cluster" + indiceDelClusterMasCercano(distancesToClusters, numberOfClusters);
		System.out.println("Cluster elegido: " + cluster);
		Integer numeroInstancia = numeroDeInstanciaDelaMejorInstancia(cluster);
		...
		return generaDecisionAPartirDeLaInstancia(mejorInstanciaArff);
	}

	private Integer numeroDeInstanciaDelaMejorInstancia(String cluster) {
		List<String[]> instanciaAGuardar = new ArrayList<String[]>();
		instanciaAGuardar = extraerInstanciasDelClusterSeleccionado(cluster);
	...
	private Decisiones generaDecisionAPartirDeLaInstancia(String[] mejorInstanciaArff) {
	...
	private List<String[]> extraerInstanciasDelClusterSeleccionado(String cluster) {
		List<String[]> instanciaAGuardar = new ArrayList<String[]>();
	 ...
	 * clúster.
	 */
	private int indiceDelClusterMasCercano(double[] distanciasACentroides, int numberOfClusters) {
	 ...
	 */
	private double[] calculateDistancesToClusters(int numberOfClusters) {
