...
public class AgenteClusteringROI extends Agente {
	 ...
	 * @param nombreEquipo
	 */
	public AgenteClusteringROI(String codSimulacion, String nombreMercado, String nombreEquipo) {
	...
	private static final String NOMBRE_ARCHIVO_CENTROIDES = "kmediasROI.txt";
	private static final String NOMBRE_ARCHIVO_CLUSTERIZADO = "clusteringROI.arff";
	private static final String NOMBRE_ARCHIVO_ROI = "roi.arff";
	...
	public static void main(String[] args) {
		AgenteClusteringROI agente = new AgenteClusteringROI("", "", "");
	...
	public Decisiones tomarDecisiones() {
		...
		List<String[]> instanciasROIArff = new ArrayList<String[]>();
		try {
			BufferedReader in = new BufferedReader(new FileReader(NOMBRE_ARCHIVO_ROI));
			String str = null;
			boolean ignorar = true;
			while ((str = in.readLine()) != null) {
				if (str.equalsIgnoreCase("@data")) {
